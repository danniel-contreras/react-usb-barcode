...
export const AddProduct = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: yup.object({
      ...
      price: yup.number().required('El precio es requerido').typeError('Precio invalido'),
      stock: yup.number().required('El stock es requerido').typeError('stock invalido'),
      minimunStock: yup
        .number()
          ...
          <div className="grid grid-cols-2">
            <div>
              <div className="flex flex-col p-1 mt-1 w-96 text-justify">
                ...
                />
                {formik.errors.name && formik.touched.name && (
                  <span className="text-sm font-normal text-red-400">{formik.errors.name}</span>
                )}
              </div>
              <div className="flex flex-col p-1 mt-1 w-96 text-justify">
                <label className="text-sm font-semibold text-gradient">Categoria</label>
                <select
                  name="categoriesId"
              ...
              <div className="flex flex-col p-1 mt-1 w-96 text-justify">
                <label className="text-sm font-semibold text-gradient">Sucursal</label>
                <select
                  name="storesId"
                  disabled
              ...
              <div className="flex flex-col p-1 mt-1 w-96 text-justify">
                <label className="text-sm font-semibold text-gradient">Codigo</label>
                <input
                  ref={barcode_input}
                  type="text"
                  name="code"
                ...
                />
                {formik.errors.code && formik.touched.code && (
                  <span className="text-sm font-normal text-red-400">{formik.errors.code}</span>
                )}
              </div>
            </div>
            <div>
              <div className="flex flex-col p-1 mt-1 w-96 text-justify">
                ...
                />
                {formik.errors.price && formik.touched.price && (
                  <span className="text-sm font-normal text-red-400">{formik.errors.price}</span>
                )}
              </div>
              <div className="flex flex-col p-1 mt-1 w-96 text-justify">
                ...
                />
                {formik.errors.stock && formik.touched.stock && (
                  <span className="text-sm font-normal text-red-400">{formik.errors.stock}</span>
                )}
              </div>
              <div className="flex flex-col p-1 mt-1 w-96 text-justify">
                <label className="text-sm font-semibold text-gradient">Stock Minimo</label>
                <input
                  type="text"
                  name="minimunStock"
                  onChange={formik.handleChange}
