...
import { addProduct, getProductByCode } from "../api/products.api";
...
export const AddProduct = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      if (values.code !== "") {
        const prod = await getProductByCode(values.code);
        if (prod.data.ok) {
          toast.error("Ya existe un producto con este codigo");
          return;
        }
      }
